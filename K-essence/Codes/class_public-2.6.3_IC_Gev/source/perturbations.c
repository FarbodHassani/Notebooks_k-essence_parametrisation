...
int perturb_einstein(
  ...
  if (_scalars_) {
    ...
    if (ppt->gauge == newtonian) {
      ...
      //     // double psi_Sync = ppw->pvecmetric[ppw->index_mt_alpha_prime] + H*ppw->pvecmetric[ppw->index_mt_alpha];
           FILE * out1=fopen("./output/Kessence_field_class_phi_prime_z0.dat","a");
          fprintf(out1,"%e\t %e\t %e\t %e\t %e\t \n",k, (1./a) - 1. ,ppw->pvecmetric[ppw->index_mt_phi_prime]/a_prime_over_a, ppw->pvecmetric[ppw->index_mt_psi] ,a_prime_over_a/pba->H0 );
          fclose(out1);
          }
      }

      if (fabs(a-1./(1+0.988975))<0.005 )
    {
    //  /**K is 1/Mpc */
      if( k<10. )
      {            // double pi_newton = ppw->pvecmetric[ppw->index_mt_vx_smg] + ppw->pvecmetric[ppw->index_mt_alpha]; // scalar field in Newtonian gauge --> Gauge transformation: pi(Newt)=pi(Sync)+ alpha
    ...
    //     // double pi_synch=ppw->pvecmetric[ppw->index_mt_vx_smg];
    //     // double psi_Sync = ppw->pvecmetric[ppw->index_mt_alpha_prime] + H*ppw->pvecmetric[ppw->index_mt_alpha];
         FILE * out1=fopen("./output/Kessence_field_class_phi_prime_z1.dat","a");
        fprintf(out1,"%e\t %e\t %e\t %e\t %e\t \n",k, (1./a) - 1. ,ppw->pvecmetric[ppw->index_mt_phi_prime]/a_prime_over_a, ppw->pvecmetric[ppw->index_mt_psi] ,a_prime_over_a/pba->H0 );
        fclose(out1);
        }
    }

    if (fabs(a-1./(1+5.808126))<0.002 )
  {
  //  /**K is 1/Mpc */
    if( k<10. )
    {            // double pi_newton = ppw->pvecmetric[ppw->index_mt_vx_smg] + ppw->pvecmetric[ppw->index_mt_alpha]; // scalar field in Newtonian gauge --> Gauge transformation: pi(Newt)=pi(Sync)+ alpha
  ...
  //     // double pi_synch=ppw->pvecmetric[ppw->index_mt_vx_smg];
  //     // double psi_Sync = ppw->pvecmetric[ppw->index_mt_alpha_prime] + H*ppw->pvecmetric[ppw->index_mt_alpha];
       FILE * out1=fopen("./output/Kessence_field_class_phi_prime_z6.dat","a");
      fprintf(out1,"%e\t %e\t %e\t %e\t %e\t \n",k, (1./a) - 1. ,ppw->pvecmetric[ppw->index_mt_phi_prime]/a_prime_over_a, ppw->pvecmetric[ppw->index_mt_psi] ,a_prime_over_a/pba->H0 );
      fclose(out1);
      }
  }

  if (fabs(a-1./(1+9.951253))<0.0025 )
{
//  /**K is 1/Mpc */
    if( k<10. )
    {            // double pi_newton = ppw->pvecmetric[ppw->index_mt_vx_smg] + ppw->pvecmetric[ppw->index_mt_alpha]; // scalar field in Newtonian gauge --> Gauge transformation: pi(Newt)=pi(Sync)+ alpha
...
//     // double pi_synch=ppw->pvecmetric[ppw->index_mt_vx_smg];
//     // double psi_Sync = ppw->pvecmetric[ppw->index_mt_alpha_prime] + H*ppw->pvecmetric[ppw->index_mt_alpha];
     FILE * out1=fopen("./output/Kessence_field_class_phi_prime_z10.dat","a");
    fprintf(out1,"%e\t %e\t %e\t %e\t %e\t \n",k, (1./a) - 1. ,ppw->pvecmetric[ppw->index_mt_phi_prime]/a_prime_over_a, ppw->pvecmetric[ppw->index_mt_psi] ,a_prime_over_a/pba->H0 );
    fclose(out1);
    }
}

if (fabs(a-1./(1+48.322258))<0.0005 )
{
//  /**K is 1/Mpc */
  if( k<10. )
  {            // double pi_newton = ppw->pvecmetric[ppw->index_mt_vx_smg] + ppw->pvecmetric[ppw->index_mt_alpha]; // scalar field in Newtonian gauge --> Gauge transformation: pi(Newt)=pi(Sync)+ alpha
...
//     // double pi_synch=ppw->pvecmetric[ppw->index_mt_vx_smg];
//     // double psi_Sync = ppw->pvecmetric[ppw->index_mt_alpha_prime] + H*ppw->pvecmetric[ppw->index_mt_alpha];
   FILE * out1=fopen("./output/Kessence_field_class_phi_prime_z50.dat","a");
  fprintf(out1,"%e\t %e\t %e\t %e\t %e\t \n",k, (1./a) - 1. ,ppw->pvecmetric[ppw->index_mt_phi_prime]/a_prime_over_a, ppw->pvecmetric[ppw->index_mt_psi] ,a_prime_over_a/pba->H0 );
  fclose(out1);
  }
}

if (fabs(a-1./(1+99.597220))<0.00025 )
{
  //  /**K is 1/Mpc */
    if( k<10. )
    {            // double pi_newton = ppw->pvecmetric[ppw->index_mt_vx_smg] + ppw->pvecmetric[ppw->index_mt_alpha]; // scalar field in Newtonian gauge --> Gauge transformation: pi(Newt)=pi(Sync)+ alpha
  ...
  //     // double pi_synch=ppw->pvecmetric[ppw->index_mt_vx_smg];
  //     // double psi_Sync = ppw->pvecmetric[ppw->index_mt_alpha_prime] + H*ppw->pvecmetric[ppw->index_mt_alpha];
     FILE * out1=fopen("./output/Kessence_field_class_phi_prime_z100.dat","a");
    fprintf(out1,"%e\t %e\t %e\t %e\t %e\t \n",k, (1./a) - 1. ,ppw->pvecmetric[ppw->index_mt_phi_prime]/a_prime_over_a, ppw->pvecmetric[ppw->index_mt_psi] ,a_prime_over_a/pba->H0 );
    fclose(out1);
    }
}
    ...
    if (ppt->gauge == synchronous) {
      ...
      ppw->pvecmetric[ppw->index_mt_alpha_prime] =  //TBC
        ...
        //*********************************
        // Printing the fields
        if (fabs(a-1./(1+100.))<0.0008 || fabs(a-1./(1+10.))<0.008  || fabs(a-1./(1+3.))<0.08 ||  fabs(a-1./(1+0.))<0.08  )
        {
         /**K is 1/Mpc */
          if( k<5. )
          {            // double pi_newton = ppw->pvecmetric[ppw->index_mt_vx_smg] + ppw->pvecmetric[ppw->index_mt_alpha]; // scalar field in Newtonian gauge --> Gauge transformation: pi(Newt)=pi(Sync)+ alpha
            // double pi_prime_newton=ppw->pvecmetric[ppw->index_mt_vx_prime_smg] + ppw->pvecmetric[ppw->index_mt_alpha_prime];
            // double pi_synch=ppw->pvecmetric[ppw->index_mt_vx_smg];
            double psi_Sync = ppw->pvecmetric[ppw->index_mt_alpha_prime] + a* ppw->pvecback[pba->index_bg_H]*ppw->pvecmetric[ppw->index_mt_alpha];
             FILE * out1=fopen("./output/Kessence_field_class_synch.dat","a");
            fprintf(out1,"%e\t %e\t %e\t %e\t %e\t %e\t \n",k, a ,psi_Sync,ppw->pvecmetric[ppw->index_mt_alpha], ppw->pvecmetric[ppw->index_mt_alpha_prime], ppw->pvecback[pba->index_bg_H] );
            fclose(out1);
            }
        }
        //*********************************
