...
#pragma omp parallel for private(phi,phiprime,gradphi,tidalphi,ngradphi,nntidalphi,e1gradphi,e2gradphi,eetidalphi,exp2phi,v,tmp,dist,source_dist,dn_dtau,dlnk0_dtau,filename,outfile), reduction(+:num_live), reduction(min:min_dist), reduction(max:max_dist)
			for (int n = 0; n < Nsource; n++)
			{
...
#pragma omp critical(evala)
				{
					...
					fprintf(outfile, " %f  %f  %f  %e  %e  %e  %e  %e  %e  %e  %e  %e  %e  %e  %e  %e  %e  %e  %e  %e  %e  %e  %e  %e\n", photon[n].pos[0], photon[n].pos[1], photon[n].pos[2], exp(photon[n].lnk0) / gsl_spline_eval (aspline, tau, acc) / gsl_spline_eval (aspline, tau, acc), phi, photon[n].DA * gsl_spline_eval (aspline, tau, acc), photon[n].sigma[0], photon[n].sigma[1], photon[n].ellip[0], photon[n].ellip[1], tmp[0], tmp[1], tmp[2], nntidalphi, tidalphi[0] + tidalphi[3] + tidalphi[5], photon[n].e1[0]*photon[n].e1[0]*tidalphi[0] + 2*photon[n].e1[0]*photon[n].e1[1]*tidalphi[1] + 2*photon[n].e1[0]*photon[n].e1[2]*tidalphi[2] + photon[n].e1[1]*photon[n].e1[1]*tidalphi[3] + 2*photon[n].e1[1]*photon[n].e1[2]*tidalphi[4] + photon[n].e1[2]*photon[n].e1[2]*tidalphi[5], photon[n].e2[0]*photon[n].e2[0]*tidalphi[0] + 2*photon[n].e2[0]*photon[n].e2[1]*tidalphi[1] + 2*photon[n].e2[0]*photon[n].e2[2]*tidalphi[2] + photon[n].e2[1]*photon[n].e2[1]*tidalphi[3] + 2*photon[n].e2[1]*photon[n].e2[2]*tidalphi[4] + photon[n].e2[2]*photon[n].e2[2]*tidalphi[5], photon[n].e1[0]*photon[n].e2[0]*tidalphi[0] + photon[n].e1[0]*photon[n].e2[1]*tidalphi[1] + photon[n].e2[0]*photon[n].e1[1]*tidalphi[1] + photon[n].e1[0]*photon[n].e2[2]*tidalphi[2] + photon[n].e2[0]*photon[n].e1[2]*tidalphi[2] + photon[n].e1[1]*photon[n].e2[1]*tidalphi[3] + photon[n].e1[1]*photon[n].e2[2]*tidalphi[4] + photon[n].e2[1]*photon[n].e1[2]*tidalphi[4] + photon[n].e1[2]*photon[n].e2[2]*tidalphi[5], photon[n].n[0]*photon[n].n[0] + photon[n].n[1]*photon[n].n[1] + photon[n].n[2]*photon[n].n[2] - 1., photon[n].e1[0]*photon[n].e1[0] + photon[n].e1[1]*photon[n].e1[1] + photon[n].e1[2]*photon[n].e1[2] - 1., photon[n].e2[0]*photon[n].e2[0] + photon[n].e2[1]*photon[n].e2[1] + photon[n].e2[2]*photon[n].e2[2] - 1., photon[n].n[0]*photon[n].e1[0] + photon[n].n[1]*photon[n].e1[1] + photon[n].n[2]*photon[n].e1[2], photon[n].n[0]*photon[n].e2[0] + photon[n].n[1]*photon[n].e2[1] + photon[n].n[2]*photon[n].e2[2], photon[n].e1[0]*photon[n].e2[0] + photon[n].e1[1]*photon[n].e2[1] + photon[n].e1[2]*photon[n].e2[2]);
					fclose(outfile);
				...
				{
					photon[n].sigma[0] = (photon[n].sigma[0] - 0.5 * integration_step * photon[n].DA * photon[n].DA * eetidalphi[0] * exp2phi * exp2phi) / (1. + 0.5 * integration_step * dlnk0_dtau);
					photon[n].sigma[1] = (photon[n].sigma[1] - 0.5 * integration_step * photon[n].DA * photon[n].DA * eetidalphi[1] * exp2phi * exp2phi) / (1. + 0.5 * integration_step * dlnk0_dtau);

					photon[n].DAprime = (photon[n].DAprime + integration_step * photon[n].DA * (nntidalphi - tidalphi[0] - tidalphi[3] - tidalphi[5]) * exp2phi * exp2phi - integration_step * (photon[n].sigma[0]*photon[n].sigma[0] + photon[n].sigma[1]*photon[n].sigma[1]) / photon[n].DA / photon[n].DA / photon[n].DA) / (1. + 0.5 * integration_step * dlnk0_dtau);
				}

				photon[n].sigma[0] = photon[n].sigma[0] * (1. - 0.5 * integration_step * dlnk0_dtau) - 0.5 * integration_step * photon[n].DA * photon[n].DA * eetidalphi[0] * exp2phi * exp2phi;
				photon[n].sigma[1] = photon[n].sigma[1] * (1. - 0.5 * integration_step * dlnk0_dtau) - 0.5 * integration_step * photon[n].DA * photon[n].DA * eetidalphi[1] * exp2phi * exp2phi;
				...
				for (int i = 0; i < 3; i++)
				{
					photon[n].e1[i] += integration_step * photon[n].n[i] * 2 * exp2phi * e1gradphi;
					photon[n].e2[i] += integration_step * photon[n].n[i] * 2 * exp2phi * e2gradphi;
...
bool tidal_matrix(metric_container * field_prev, metric_container * field_next, const double weight, const double dist, const double dr, double * v, double * result, int debug)
{
	...
	else if (j < (int64_t) center_prev->second.hdr.Nside * ((int64_t) center_prev->second.hdr.Nside - 1) * 2) // in north polar cap
	{
		...
		tmp /= 4 * ring / 3. / center_prev->second.hdr.Nside / center_prev->second.hdr.Nside;
		...
		cph /= 2. * (2*ring-1) * (2*ring+1) * ring / 9. / center_prev->second.hdr.Nside / center_prev->second.hdr.Nside / center_prev->second.hdr.Nside / center_prev->second.hdr.Nside;
		...
		sth /= 4 * ring / 3. / center_prev->second.hdr.Nside / center_prev->second.hdr.Nside;
		sth += cph / 3. / center_prev->second.hdr.Nside / center_prev->second.hdr.Nside;
